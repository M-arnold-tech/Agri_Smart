      ...
      <section className="flex items-center justify-between min-h-[calc(100vh-64px-4rem)] lg:flex-row flex-col text-center lg:text-left px-8 lg:px-16 bg-gradient-to-br from-background to-[#e8f5e9] rounded-xl m-4 overflow-hidden relative p-8 lg:p-16">
        <div className="flex-1 max-w-[600px] z-10">
          ...
          <p className="text-xl text-text-muted mb-10 leading-relaxed">
            Agri_Smart bridges the gap between local farmers and certified
            agricultural advisors. Get real-time consultation, crop calendars,
            and weather alerts to maximize your yield.
          </p>
      ...
      <section className="px-8 lg:px-16 max-w-7xl mx-auto w-full">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-primary-dark mb-4">
            Why Choose Agri_Smart?
          </h2>
          <p className="text-lg text-text-muted">
            Everything you need to grow smarter and faster.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <Card className="flex flex-col items-start p-8 bg-white transition-all hover:-translate-y-1.5  border-none shadow-[0_10px_30px_rgba(0,0,0,0.03)]  group">
            ...
            <h3 className="text-xl font-semibold mb-3 text-text-main">
              Expert Consultations
            </h3>
            <p className="text-text-muted leading-relaxed">
              Connect directly with certified agricultural advisors for tailored
          ...
          <Card className="flex flex-col items-start p-8 bg-white transition-all hover:-translate-y-1.5  border-none shadow-[0_10px_30px_rgba(0,0,0,0.03)]  group">
            ...
            <p className="text-text-muted leading-relaxed">
              Get personalized task notifications and crop calendars to never
              miss a crucial farming step.
            </p>
          </Card>
          ...
          <Card className="flex flex-col items-start p-8 bg-white transition-all hover:-translate-y-1.5  border-none shadow-[0_10px_30px_rgba(0,0,0,0.03)]  group">
            ...
            <p className="text-text-muted leading-relaxed">
              Receive localized weather forecasts and warnings to protect your
              harvest from unexpected changes.
            </p>
          </Card>
          ...
          <Card className="flex flex-col items-start p-8 bg-white transition-all hover:-translate-y-1.5  border-none shadow-[0_10px_30px_rgba(0,0,0,0.03)]  group">
            ...
            <p className="text-text-muted leading-relaxed">
              Access a rich knowledge base of manuals, guides, and best
              practices available offline.
            </p>
          </Card>
        </div>
      </section>
