  ...
  return (
    <div className="flex flex-col gap-8 animate-fade-in">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 px-4 py-2 rounded-sm bg-primary/10 text-primary text-xs font-bold uppercase tracking-wider border border-primary/20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="flex items-center gap-5 p-6 border-none shadow-sm bg-white hover:shadow-md transition-all group">
          ...
          <div>
            <div className="text-3xl font-bold text-text-main leading-tight">
              {stats?.farmerCount || 0}
            </div>
          ...
          <Card className="flex flex-col gap-0 p-0 overflow-hidden divide-y divide-gray-50 border-none shadow-sm bg-white rounded-3xl">
            {conversations.length > 0 ? (
              conversations.slice(0, 5).map((chat) => (
                <div
                  key={chat.id}
                  className="flex items-center justify-between p-6 hover:bg-gray-50/50 transition-colors cursor-pointer"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-text-main text-sm uppercase tracking-tight">
                        {chat.name}
                      </h4>
                  ...
                  <Link to="/advisor/chat">
                    <Button
                      size="sm"
                      variant="outline"
                      className="rounded-xl font-bold uppercase tracking-widest text-[10px] px-4"
                    >
                      Respond
                    </Button>
                  </Link>
              ...
              <div className="p-12 text-center">
                <div className="w-16 h-16 bg-gray-50 rounded-sm flex items-center justify-center mx-auto mb-4 text-gray-300">
                  <AlertCircle size={32} />
                </div>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">
                  No active inquiries
        ...
        <div className="lg:col-span-1 flex flex-col gap-6">
          <Card className="bg-[#2E7D32] text-white p-8 border-none shadow-xl shadow-primary/20 flex flex-col items-start gap-4 rounded-3xl relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xs opacity-90 leading-relaxed font-medium">
                Support your farmers by uploading updated agronomy guides and
                market trends.
              </p>
          ...
          <Card className="bg-white p-6 border-none shadow-sm rounded-3xl flex flex-col gap-4">
            ...
            <div className="flex items-end gap-2">
              ...
              <span className="text-[10px] font-bold text-[#2E7D32]/60 uppercase tracking-widest pb-1.5">
                Advisor Rating
              </span>
            </div>
            <div className="w-full bg-gray-100 rounded-sm h-2">
              <div
                className="bg-[#2E7D32] h-2 rounded-sm transition-all duration-1000"
